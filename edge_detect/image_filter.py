...
class MainSettings:
	...
	exclude_area_param_set: list[str] = tst.option(default=[],
		help=f"Exclude a set of image area parameter names : { list(ImageAreaParamName)}",
	)

from os import environ as os_environ
#import click
@tst.settings(MainSettings)#, __name__)
#@click.command()
def main(args: MainSettings,
	...
	click.echo(f"Connecting to: {args}")
	try:
